...
<?php include("include/slider.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="p-3">
<form class="bg-white p-3 rounded shadow" style="border-left: 4px solid #008693;" method="post" enctype="multipart/form-data" action="../seller_action/add_company">
  ...
  <?php 
    $ID = $_SESSION["data"]["id"];
  $supp_list = DBHelper::get("SELECT * FROM `company` where addedBy = '{$ID}'");
...
<script>
    document.getElementById("p_title").innerText = "Product company";
</script>
