...
if(!empty($profile["image"])){
   $path = "../images/master_team/".$profile["image"];
}
else{
...
$total_balance = DBHelper::get("SELECT * FROM `tbl_customer_credit_total` WHERE cusID = '{$ID}' and type = 3")->fetch_assoc()["amount"];
$refter = DBHelper::get("SELECT count(id) as total FROM `tbl_customer_credit_trans` WHERE cusID = '{$ID}' and type = 3 and tran_type = 2")->fetch_assoc()["total"];

if($profile["mobile_account_type"] == '1'){
  $pp_type ="Jazzcash";
}
elseif($profile["mobile_account_type"] == '2'){
  $pp_type = "Easypaisa";
}
else{
    $pp_type ="Mobi cash";
...
?>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">Master team</p>
              ...
              <div class="card-body">
                ...
                <!-- Tab 1 start -->
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                        <?php 
                        $tran = DBHelper::get("SELECT * FROM `tbl_customer_credit_trans` WHERE cusID = '{$ID}' and type = 3");
                        if($tran->num_rows > 0){
    ...
    <script>
    document.getElementById("p_title").innerText = "Master team profile";
   </script>