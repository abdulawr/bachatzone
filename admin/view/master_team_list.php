    ...
    <section class="content mt-2">
      ...
      <div class="card" style="border-left:4px solid #46775c;">
        ...
        <table id="ts_table" class="table table-bordered table-hover mt-3">
                  ...
                  $data = DBHelper::get("SELECT * FROM `investor` where type = '1' $search_dd");
                      ...
                      while($row = $data->fetch_assoc()){
                          ...
                          ?>
                            <tr style="vertical-align: middle;">
                                ...
                                <td>
                                    <a href="?p=master_team_profile&id=<?php echo $row["id"];?>" title="Delete Investor"><i class="fas fa-user text-success"></i></a>
                                    <a href="?p=add_master_team&ID=<?php echo $row["id"];?>" title="Edit Investor"><i class="fas fa-pencil-alt text-warning"></i></a>
                                </td>
                            </tr>
                          <?php
                      }
...
<script>
    document.getElementById("p_title").innerText = "Master team list";
</script>
