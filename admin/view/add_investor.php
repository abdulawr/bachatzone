...
?>
<div class="p-3">
<form class="bg-white p-3 rounded shadow" style="border-left: 4px solid #008693;" method="post" enctype="multipart/form-data" action="action/add_investor">
  <h5 style="background-color: #008693; color:white; padding:3px 10px;">Personal Information</h5>
   <?php
   if(isset($_GET["msg"])){
       switch($_GET["msg"]){
           case 'succ_updated':
            msg("Investor profile updated successfully!",1);
            break;

           case 'succ_insert':
            msg("Investor account created successfully",1);
            break;

           case 'already_exist':
            msg("Investor account already exist!",2);
            break;
       }
   }
  ...
  <h5 class="mt-3 mb-3" style="background-color: #008693; color:white; padding:3px 10px;">Accounts Information</h5>
  <div class="row">
  <div class="form-group col">
  ...
  <h5 class="mt-3 mb-3" style="background-color: #008693; color:white; padding:3px 10px;">Bank Account</h5>
  <div class="row">
  <div class="form-group col">
...
<script>
    document.getElementById("p_title").innerText = "Add investor";
</script>